...
Public Class Danh_sach_khach_hang
    ...
    Private Sub bt1_Click(sender As Object, e As EventArgs) Handles btxemdulieu2.Click
        ...
        bangdulieuKH1.DataSource = tb
        connect.Close()
    End Sub

    Private Sub chinhsuadulieuKH_Click(sender As Object, e As EventArgs) Handles chinhsuadulieuKH.Click
        chinh_sua_du_lieu_2.Show()
        Me.Close()
    End Sub
