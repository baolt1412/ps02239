...
Public Class Danh_sach_loai_san_pham

    Private Sub chinhsuadulieuLSP_Click(sender As Object, e As EventArgs) Handles chinhsuadulieuLSP.Click
        Chinh_sua_du_lieu_3.Show()
        Me.Close()
    End Sub

    Private Sub btxemdulieuLSP2_Click(sender As Object, e As EventArgs) Handles btxemdulieuLSP2.Click
