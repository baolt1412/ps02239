...
Public Class Danh_sach_hoa_don
    ...
    Private Sub btxemdulieuHD2_Click(sender As Object, e As EventArgs) Handles btxemdulieuHD2.Click
        ...
        bangdulieuHD1.DataSource = tb
        connect.Close()
    End Sub

    Private Sub chinhsuadulieuHD_Click(sender As Object, e As EventArgs) Handles chinhsuadulieuHD.Click
        Chinh_sua_du_lieu_4.Show()
        Me.Close()
    End Sub
